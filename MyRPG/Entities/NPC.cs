...
namespace MyRPG.Entities
{
    public class NPC : Entity
    {
        ...
        public NPC(Texture2D texture, Vector2 startPosition, string dialogue, string roomName = "hallway") 
        ...
        public void Update(Room room, Player player, List<NPC> otherNPCs)
        {
        ...
        private bool CheckEntityCollision(Vector2 newPos, Player player, List<NPC> otherNPCs)
        {
            ...
            foreach (var other in otherNPCs)
            {
                ...
                if (CheckCollision(newPos, other.Position, other.Width, other.Height))
                    return true;
            }
